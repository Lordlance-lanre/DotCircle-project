...
<div class="text-white">
	<div class="flex justify-center mt-20 md:mt-36 text-2xl md:text-7xl h-10 md:h-20 font-bold ">
		<h1 class="design mr-2">Design<span class="text-white">.</span></h1>
		<h3 class="ml-1">Develop<span>.</span></h3>
		<h3 class="ml-3">Maintain<span>.</span></h3>
	</div>

	<div>
		<p class="mt-2 md:mt-4 text-center md:text-lg font-extralight text-[9px]">World class design and engineering teams to get your ideas and projects <br> up and running quickly</p>
	</div>

	<section class="flex justify-center mt-10">
		<button class="text-black bg-white rounded hover:bg-zinc-900 hover:text-gray-100 transition ease-in-out duration-500 mr-5 px-3  py-1 tracking-wide">Start a Project</button>

		<button class="glow text-white bg-black border-2 border-blue-400 rounded hover:bg-zinc-900 hover:text-gray-100 transition ease-in-out duration-500 px-3  py-1 tracking-wide hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)]">Free consultations</button>
	</section>
	...
	<section class="mt-32 pb-4">
		<h2 class="text text-center text-2xl md:text-5xl font-light md:mb-2">Have a great project in mind?</h2>
		<p class="text text-center text-2xl md:text-5xl font-light mb-7">Let's get started</p>
		<button class="flex mx-auto border border-zinc-500 bg-zinc-800 rounded-lg px-5 py-2 text-xs hover:bg-zinc-700 hover:text-black transition ease-in-out duration-500">Contact us</button>
	</section>
</div>
</template>
...
.design{
background: #4B29CF;
background: linear-gradient(to right, #0808CF 0%, #3D38CF 57%);
